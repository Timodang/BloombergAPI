...
class Strategy:
    ...
    def __init__(
        ...
        self.cheapness = df_valo.divide(df_prices)
    ...
    def get_sector_weights( self, sector: str, current_date: datetime.datetime, action: str, existing_positions: Optional[pd.DataFrame] = None ) -> pd.DataFrame:
        """
    ...
    def _compute_equalweight_positions(self, signals: Dict[str, float]) -> Dict[str, float]:
        """
